...
public class SpellingBeeController {
    ...
    @FXML
    protected void onButton1Click(){kelimeText.appendText(Button1.getText());}

    @FXML
    protected void onButton2Click(){kelimeText.appendText(Button2.getText());}

    @FXML
    protected void onButton3Click(){kelimeText.appendText(Button3.getText());}

    @FXML
    protected void onButton4Click(){kelimeText.appendText(Button4.getText());}

    @FXML
    protected void onButton5Click(){kelimeText.appendText(Button5.getText());}

    @FXML
    protected void onButton6Click(){kelimeText.appendText(Button6.getText());}

    @FXML
    protected void onButton7Click(){kelimeText.appendText(Button7.getText());}
